...
public class AVLIntervalTreeTest {
    ...
    public void main() {
        ...
        AVLIntervalNode node1 = new AVLIntervalNode(new Interval(50, 75), 10, 1);
        AVLIntervalNode node2 = new AVLIntervalNode(new Interval(25, 85), 15, 2);
        AVLIntervalNode node3 = new AVLIntervalNode(new Interval(75, 95), 20, 3);
        AVLIntervalNode node4 = new AVLIntervalNode(new Interval(15, 105), 25, 4);
        AVLIntervalNode node5 = new AVLIntervalNode(new Interval(35, 918), 30, 5);
        AVLIntervalNode node6 = new AVLIntervalNode(new Interval(60, 838), 35, 6);
        AVLIntervalNode node7 = new AVLIntervalNode(new Interval(120, 738), 40, 7);
        AVLIntervalNode node8 = new AVLIntervalNode(new Interval(10, 638), 45, 8);
